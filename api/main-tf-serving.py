# Unlike the normal implementation of FastAPI for the ML Model..the FastAPI only deals with generation of numpy arrays etc..
# the 'tf-server' will handle the prediction operations => slight change in ARCHITECTURE
...
# tf-serving will expect 'instances' as a dictionary key which references list of batch of images
